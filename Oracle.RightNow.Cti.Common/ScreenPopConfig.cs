...
namespace Oracle.RightNow.Cti.Common
{
    ...
    [RightNowCustomObjectAttribute(OracleCtiObjectStrings.ScreenPopPackageName, OracleCtiObjectStrings.AgentState)]
    public class AgentState
    {
        ...
        [RightNowCustomObjectField("DefaultName", ItemsChoiceType.StringValue)]
